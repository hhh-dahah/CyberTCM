...
# ==================== 加入我们页面 ====================
    ...
    # 团队介绍卡片 - 使用Streamlit原生组件
    with st.container():
        st.markdown("---")
        st.write("**CyberTCM 是一个充满激情的年轻团队，我们致力于用现代科技传承千年中医智慧。**")
        
        st.write("**在这里，你将：**")
        st.write("🌱 接触最前沿的中医数字化项目")
        st.write("🤝 与志同道合的伙伴一起成长")
        st.write("💡 发挥创意，贡献你的想法")
        st.write("📚 学习中医知识与现代技术的结合")
        ...
        st.write("📊 数据分析爱好者")
        st.write("🌿 对中医文化有热情的你")
        st.write("✨ 愿意贡献时间和创意的志愿者")
        
        st.success("无论你是技术大牛还是初学者，只要你对项目感兴趣，我们都欢迎你的加入！")
    ...
    x_text = '''
📝 先说实话
我们是个大学生创新团队，做中医体质研究。计算机背景，目前缺中医领域的同学，也缺懂运营、懂传播的朋友。
但缺人不是最要紧的。一个项目、几个人，决定不了什么。
我们在尝试一种不同的组织方式
未来真正的竞争力，是定义问题的能力和解决问题的速度。这需要一群人共享信息、真实地从生活里发现问题、把各自的能力拼接起来——形成一个能力群。
我们学生没有社会大佬的深耕，但我们学得快。如果能把学习过程分享出来，把技能交换出去，普通人聚在一起也能做大事。
所以我们模仿微生物的"质粒"：信息快速交换，变化永不停止。
具体怎么做？
 
每人建一张角色卡，写明你的技能货架
 
每个有价值的任务过程必须交付最小化文档，确保信息流动
 
结对制度：两两配对，互相学习对方的核心技能
 
用成果吸引更多人，让团队自然生长

我们在找这样的人
不需要你已经很强，但需要你真的想成长。愿意写文档、愿意教别人、愿意承认不懂、愿意在交换中变强。
如果你对这种"笨拙但诚实"的成长方式有共鸣，欢迎联系我们。
'''
    st.info(x_text)
